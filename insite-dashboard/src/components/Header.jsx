  ...
  return (
    <header style={{
      ...
      <div style={{
          ...
          <div ref={dropdownRef} style={{ position: 'relative' }}>
            ...
            {servicesOpen && (
              <div style={{
                ...
                {/* Overview link */}
                <Link to="/services" style={{ display: 'block', padding: '10px 14px', borderRadius: 10, textDecoration: 'none', marginBottom: 4, borderBottom: '1px solid rgba(255,255,255,0.06)', paddingBottom: 12 }}
                ...
                {/* Sub-links */}
                {serviceLinks.map(s => (
                  <Link key={s.to} to={s.to} style={{ display: 'flex', alignItems: 'flex-start', gap: 12, padding: '10px 14px', borderRadius: 10, textDecoration: 'none', transition: 'background 0.15s' }}
                    onMouseEnter={e => e.currentTarget.style.background = 'rgba(255,255,255,0.05)'}
                    onMouseLeave={e => e.currentTarget.style.background = 'transparent'}
                  >
        ...
        {/* CTA */}
        <Link to="/contact" className="header-cta" style={{
        ...
        <div style={{
          ...
          {mobileServicesOpen && (
            <div style={{ padding: '4px 0 8px 12px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
              <Link to="/services" style={{ display: 'block', color: '#8898b4', textDecoration: 'none', fontSize: 14, padding: '8px 0' }}>Overview — All Services</Link>
              {serviceLinks.map(s => (
                <Link key={s.to} to={s.to} style={{ display: 'flex', alignItems: 'center', gap: 8, color: '#8898b4', textDecoration: 'none', fontSize: 14, padding: '8px 0' }}>
