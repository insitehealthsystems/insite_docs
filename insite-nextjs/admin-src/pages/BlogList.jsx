  ...
  return (
    <div style={{ maxWidth: 1100, margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: 24, display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
        ...
        <Link href="/admin/dashboard/blog/new" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: '#00d9a6', color: '#0a0f1e', textDecoration: 'none', fontWeight: 700, fontSize: 14, padding: '10px 20px', borderRadius: 10, transition: 'all 0.2s', boxShadow: '0 4px 16px rgba(0,217,166,0.25)', whiteSpace: 'nowrap' }}
      ...
      <div style={{ background: 'rgba(28,36,56,0.55)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 16, overflow: 'hidden' }}>
        {filtered.length === 0 ? (
          <div style={{ padding: '60px 24px', textAlign: 'center' }}>
            ...
            <Link href="/admin/dashboard/blog/new" style={{ color: '#00d9a6', fontSize: 14, textDecoration: 'none', fontWeight: 600 }}>Create your first post →</Link>
          </div>
        ) : (
